...
describe('Search Functions', () => {
    it('filterWithSearchQuery works with GlossaryElements', () => {
		...
		let filteredPosts = filterWithSearchQuery(unfilteredGlossaryPosts, 'window')
	...
	it('filterWithSearchQuery works with IndexElements', () => {
		...
		let filteredPosts = filterWithSearchQuery(unfilteredIndexPosts, 'lemon')
	...
	it('filterWithSearchQuery works with empty array', () => {
		...
		let filteredPosts = filterWithSearchQuery(unfilteredIndexPosts, 'hello')
