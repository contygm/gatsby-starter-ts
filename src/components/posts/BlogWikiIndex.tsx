...
/**
 * All props needed for the BlogWikiIndex component.
 ...
 * @param {BlogWikiIndexProps} props - includes allPosts, increment, type, handleFilterUpdate
 *
 * @category Components
 * @see BlogWikiIndexProps
 * @see PostCard
 */
export const BlogWikiIndex = (props: BlogWikiIndexProps) => {
